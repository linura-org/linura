...
| --- | --- | --- | --- | --- |
| `v0.9.0` | **Released — Experimental; independently verified** | [`v0.9.0.md`](v0.9.0.md) | [`published-v0.9.0.md`](published-v0.9.0.md) | [`../qualification/v0.9.0-publication.md`](../qualification/v0.9.0-publication.md) |

The immutable GitHub Release for `v0.9.0` is bound to the frozen publication-stable contract. The terminal record [`published-v0.9.0.md`](published-v0.9.0.md), the publication-evidence dossier, and `contracts/roadmap.toml` are the live current-state authorities.
