...
- Architecture decision: `docs/adr/0025-bounded-v0.6-managed-mutation-authority.md`.
- Component maturity decision: `docs/adr/0026-component-maturity-and-milestone-activation.md`.
