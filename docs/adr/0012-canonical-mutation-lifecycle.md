...
- v0.6 is the first bounded concrete composition of all eleven stages for one Experimental external effect. Its exact Authority1/process/privilege/recovery boundary is recorded in ADR 0025.
