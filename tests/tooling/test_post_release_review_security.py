...
class PostReleaseMachineHandoffSecurityTests(unittest.TestCase):
    ...
    def test_cleanup_queries_each_candidate_and_is_release_scoped(self) -> None:
        ...
        self.assertIn('tmp/{re.escape(series)}-(cleanup|compact|minimal|review|release)-', cleanup)
