...
def validate(root: Path) -> list[str]:
    ...
    for path, label in ((ADR_PATH, "ADR 0032"), (DOC_PATH, "operation semantics documentation"), (CORE_PATH, "OperationClass core type"), (DESCRIPTOR_PATH, "OperationDescriptor type")):
        candidate = root / path
